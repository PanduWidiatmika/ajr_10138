...
<body>
    ...
    <aside>
        <div class="d-flex">
            <div class="side-bar">
                <h2 class="text-light text-center pt-2">AJR | MGR</h2>
                <hr>
                <div class="menu">
                    <div class="content-menu">
                        <i class="fa fa-columns"></i>
                        <a href="./dashboardPageMGR.php" style="font-weight:600">Dashboard</a>
                    </div>
                    <div class="content-menu ">
                    ...
                    <div class="content-menu ">
                        <i class="fa fa-plus-square"></i>
                        <a href="./addJadwalPage.php" style="font-weight:600">Add Jadwal</a>
                    </div>
                    <div class="content-menu ">
