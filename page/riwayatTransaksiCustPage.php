    ...
    <div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px solid #17337A; box-shadow: 2px 3px 10px #888888;" >
        ...
        <hr>
            ...
            <tbody>
                ...
                $query = mysqli_query($con, "SELECT * FROM transaksi t LEFT JOIN driver d ON(t.ID_DRIVER=d.ID_DRIVER) JOIN mobil m ON(t.ID_MOBIL=m.ID_MOBIL) WHERE t.ID_CUSTOMER='$user[ID_CUSTOMER]' AND t.STATUS_TRANSAKSI='Selesai' ") or die(mysqli_error($con));
                ...
                if (mysqli_num_rows($query) == 0) {
                    ...
                    echo'
                        <tr>
                            ...
                            <td style="padding-left: 0px !important"><a href="./cekNotaCustPage.php?ID_TRANSAKSI='.$data['ID_TRANSAKSI'].'"><button class="btn btn-success">Cek Nota</button></a>                         
                            </td>
                        </tr>';
                        $no++;
                        }
