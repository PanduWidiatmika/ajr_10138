...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand fw-bold" href="/ajr_10138">AJR</a>
      </div>
    </nav>
          ...
          <div class="card-body">
            <form action="../process/registerProcess.php" method="post">
              ...
              <div class="mb-3">
                ...
                <input class="form-control" id="sim" name="sim" aria-describedby="emailHelp" />
              </div>
              <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Email</label>
                <input class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="example@email.com" required/>
              </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anony- mous"></script>
  </body>
</html>
